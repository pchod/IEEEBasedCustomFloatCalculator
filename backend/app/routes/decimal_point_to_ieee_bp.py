...
decimal_point_to_ieee_bp = Blueprint('decimal_point_to_ieee_bp', __name__)
decimal_schema = denary_number_schema.DecimalNumberSchema()
number_representation_schema = number_representation_schema.NumberRepresentationSchema()


@decimal_point_to_ieee_bp.route('/api/v1/decimal_point_to_ieee/<string:ieee_format>', methods=['POST'])
def decimal_point_to_ieee(ieee_format):
    ...
    try:
        ...
        decimal_point = decimal_schema.load(data.get('decimal_number'))
        ...
        number_representation_instance = CalculatorService.calculate_ieee_from_decimal(decimal_point, ieee_format_instance)
