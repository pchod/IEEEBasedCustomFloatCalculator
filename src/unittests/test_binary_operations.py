...
def test_convert_to_binary_fraction_whole_part(self):
    ...
    self.assertEqual(whole_part, "1")  # Corrected
    self.assertEqual(remainder, "0")   # Corrected
    ...
    self.assertEqual(whole_part, "10")  # Corrected
    self.assertEqual(remainder, "0001") # Corrected
    ...
    self.assertEqual(whole_part, "100") # Corrected
    self.assertEqual(remainder, "1")    # Corrected
    ...
    self.assertEqual(whole_part, "1")  # Corrected
    self.assertEqual(remainder, "00") # Corrected
    ...
    self.assertEqual(whole_part, "1")    # Corrected
    self.assertEqual(remainder, "11100") # Corrected
...
# Existing code...
    ...
    def test_convert_to_binary_fraction_whole_part(self):
        ...
        self.assertEqual(whole_part, "0")
        self.assertEqual(remainder, "101")
        ...
        whole_part, remainder = (
            BinaryOperations.convert_to_binary_fraction_whole_part(
                "101011010101010110101010101101010101010101010101101010101011010101010101010101010101101010101011010101010101010101010101010101101010101011010101010101010101010101010101101010101011010101010101010101010101010101",
                "110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110110",
            )
        )
        self.assertEqual(
